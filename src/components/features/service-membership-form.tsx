          ...
          <div className="card-glass relative w-full max-w-md space-y-5 overflow-hidden rounded-3xl border border-amber-500/40 bg-stone-950/95 p-6 text-center shadow-2xl backdrop-blur-2xl">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-slate-300">
                Your subscription contribution has been recorded.
              </p>
            </div>
            ...
            <div className="flex gap-2">
              <Link
                ...
                className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-xl border border-amber-500/40 bg-amber-500/20 py-2.5 text-xs font-bold text-amber-300 transition-colors hover:bg-amber-500/30"
              >
                <History className="h-4 w-4" /> Check Status
              </Link>
              <button
                type="button"
                onClick={() => window.location.reload()}
                className="inline-flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-500 py-2.5 text-xs font-black tracking-wider text-stone-950 uppercase transition-transform hover:scale-[1.02]"
              >
                <RefreshCw className="h-4 w-4" /> Pay Again
              </button>
            </div>
          </div>
        </div>
