      ...
      <div className="relative flex flex-col items-center justify-center">
        ...
        <div className="relative flex flex-col items-center justify-center rounded-2xl border border-amber-500/20 bg-white/80 px-6 py-4 shadow-lg backdrop-blur-2xl dark:border-white/10 dark:bg-stone-900/90">
          <Image
            ...
            width={160}
            height={48}
            className="h-8 w-auto animate-pulse object-contain transition-all duration-300 md:h-10"
            priority
          />
        </div>
        ...
        <div className="mt-4 flex items-center justify-center gap-2">
          ...
          {showText && (
            <span className="flex items-center gap-1.5 text-[11px] font-black tracking-widest text-amber-700 uppercase dark:text-amber-400">
