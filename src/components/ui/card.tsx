...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/80 backdrop-blur-sm transition-all duration-200 hover:shadow-md',
      className
    )}
    {...props}
  />
